    ...
    <ContainerHome>
      <Container>
        ...
        <HomeBox>
          ...
          <BarbeirosContainer>
            <ItemBox>
              ...
              {/* <ImgBarbeiro
                source={{ uri: barbeiros.idBarbeiroNavigation.foto }}
              />

              <NomeBarbeiro>{barbeiros.idBarbeiroNavigation.nome}</NomeBarbeiro> */}
            </ItemBox>
            <ItemBox>
        ...
        <HomeBox>
          ...
          <SobreNosText>
            Na BarberDevs, somos mais do que apenas barbeiros, somos artistas
            que transformam cabelos em obras de arte. Acreditamos que um corte
            de cabelo vai além da estética, é uma forma de expressão individual,
            um momento de cuidado pessoal e um impulso de autoestima.
          </SobreNosText>
        </HomeBox>
